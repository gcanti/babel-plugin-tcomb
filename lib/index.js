...
exports.default = function (_ref) {
  ...
  function getAssert(_ref4, typeParameters) {
    ...
    if (type.type === 'Identifier') {
      type = genericsHelper({ tcombId: tcombId, type: type });
    }
    ...
    visitor: {
      ...
      Program: {
        ...
        exit: function exit(path, state) {
          ...
          var isExtendHelperRequired = hasExtend && !state.opts[SKIP_HELPERS_OPTION];
          var isTcombImportRequired = hasTypes || isAssertHelperRequired || isExtendHelperRequired;
