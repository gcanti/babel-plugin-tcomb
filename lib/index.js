  ...
  return {
    visitor: {
      ...
      TypeCastExpression: function TypeCastExpression(path) {
        ...
        if (node.typeAnnotation && node.typeAnnotation.typeAnnotation && node.typeAnnotation.typeAnnotation.id && node.typeAnnotation.typeAnnotation.id.name === REIFY_NAME) {
          try {
